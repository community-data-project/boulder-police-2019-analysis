---
title: Analysis of Boulder Police Stop Data
...
Breaking down the stop data by "stop reason" highlights some of the reasons why this bias occurs in the top-level. While different stop types affect residents and non-residents differently, for both groups the stop type exhibiting the largest bias were for "municipal violations". Speeding and traffic violations also made up a large component of the bias, as do "suspicious" stops. Black individuals are stopped more frequently than white individuals in every type of stop listed except for "welfare checks" of non-residents, where BPD were slightly more likely to stop white individuals.  

In addition to biases in the stop rates, we find that black individuals who are searched for contraband are less likely to have it than their white counterparts. These conclusions clearly indicate that, on aggregate, BPD stop black individuals with a lower threshold of (productive) evidence. Similar results also typically hold for white hispanic individuals, although base demographic information was not provided for this group and so the results are more limited. Black hispanic individuals were also largely absent from the dataset. It should be noted that race and ethnicity were assessed by the stopping officer.

### Front Matter
Biased police stops, to us, are a clear injustice that needs to be redressed immediately. While we're glad that BPD have released this data and thereby taken a real step towards justice and transparency, it must be matched by appropriate changes in their day-to-day operations and procedures.
